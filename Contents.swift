...
//this does not work. Prints all 8000 posibilites
//for name in scholarNames{
//    for age in scholarAges{
//        for hobby in scholarHobbies{
//        print("\(name) is \(age) and likes \(hobby) in her free time.")
//        }
//    }
//}

//for index in 0...19{
//    print("\(scholarNames[index]) is \(scholarAges[index]) and likes \(scholarHobbies).")
//}
